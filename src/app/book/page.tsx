    ...
    <main>
      <section className="container pt-6 flex md:flex-row flex-col gap-8 justify-center items-start ">
        <div className="h-full flex flex-col items-start justify-start basis-1/2  mx-auto">
          ...
          <h1 className="mt-2 text-2xl tracking-widest text-white">THE DIGITAL EDITION</h1>
          ...
          <Button onClick={() => setPopUpOpen(true)} className="btn primary mt-8 text-base px-3 py-1.5">[ BUY THE DIGITAL EDITION £15 ]</Button>
